...
class LevvaAPITester:
    def __init__(self, base_url="https://levva-shipping.preview.emergentagent.com/api"):
...
def main():
    ...
    tests = [
        ...
        ("2. Carrier Registration", tester.test_carrier_registration),
        ("3. Verify Registration Token", lambda: tester.carrier_token is not None),
        ("4. Carrier Login", tester.test_carrier_login),
        ("5. Verify GET /api/auth/me", tester.test_auth_me),
        ("6. Verify Carrier Identity", tester.test_verify_carrier),
        ("7. Create Trip", tester.test_create_trip),
        ("8. Verify Trip in List", tester.test_trips_with_filters),
        ("9. Sender Registration", tester.test_sender_registration),
        ("10. Sender Login", tester.test_sender_login),
        ("11. Verify Sender Identity", tester.test_verify_sender),
        ("12. Create Shipment", tester.test_create_shipment),
        ("13. Verify Shipment in List", tester.test_list_shipments_with_filter),
        ("14. Create Match", tester.test_create_match),
        ("15. Verify Trip Status Changed", tester.test_verify_trip_status_changed),
        ("16. Verify Shipment Status Changed", tester.test_verify_shipment_status_changed),
    ]
