    ...
    try {
      ...
      await axios.put(presigned_url, file, {
        ...
        onUploadProgress: (progressEvent) => {
          const progress = Math.round((progressEvent.loaded * 60) / progressEvent.total) + 20;
      ...
      setUploadedUrl(confirmResponse.data.file_url);
      
      // Callback with the URL
      if (onUploadComplete) {
        onUploadComplete(confirmResponse.data.file_url, file_key);
      }
